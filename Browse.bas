Attribute VB_Name = "Browse"
 '------------------------------------------------------------------------------
 '
 'THIS MODULE IS USED TO CALL THE BROWSER IN FRMBROWSE IN  MARIO'S EFFECT WORKSHOP.
